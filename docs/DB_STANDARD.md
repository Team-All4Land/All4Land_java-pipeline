...
| 고시공고게시물 | `NOTI_BAS` | `NOTI_SN` | 게시물. 같은 게시물의 첨부를 묶고 담당부서·담당자·전화번호·고시공고번호를 보관한다 |
...
| 담당부서명 | `CHRG_DEPT_NM` | 담당 + 부서 + 명 | `D_NM` | — | 고시·공고 게시물을 담당하는 부서명 |
| 담당자명 | `CHRGR_NM` | 담당자 + 명 | `D_NM` | — | 고시·공고 게시물 담당자명 |
| 전화번호 | `TEL_NO` | 전화 + 번호 | `D_NO` | — | 고시·공고 게시물 담당부서 또는 담당자의 전화번호 |
