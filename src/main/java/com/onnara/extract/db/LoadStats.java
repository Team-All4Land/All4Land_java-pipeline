 ...
 *
 * @param agenciesUpserted TB_AGNCY에 반영한 기관 수 — 첨부가 0건인 폴더도 세므로
 ...
 * @param recordsInserted  삽입된 TB_NOTI_ITEM_VAL 행 수(= 표준항목 값 총합)
 * @param imagesInserted   삽입된 TB_ATCH_IMG 행 수(= 경로가 있는 이미지 총합)
 */
